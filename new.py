...
def callback_inline(call):
    if call.message:
        if call.data == "ss_1":
            bot.send_message(call.message.chat.id, "1. Не перемещая автомобиль, вызвать сотрудников "
                                                   ...
                                                   " 2. Дождаться приезда сотрудников ГИБДД/Полиции непосредственно "
                                                   " на месте происшествия и зафиксировать "
                                                   " факт повреждения автомобиля.\n"
                                                   " 3. Получить справку, с указанием всех видимых повреждений "
                                                   " Вашего автомобиля.\n 4. Поставить в известность в течение "
                                                   " рабочего дня, оформив отчет о случившемся на "
                                                   "Сервисном Портале/ Транспортный отдел.\n 5. Обратиться в страховую "
                                                   "компанию")
        if call.data == "ss_2":
        ...
        if call.data == "ss_4":
            bot.send_message(call.message.chat.id, "1. Повреждение стеклянных элементов кузова можно оформлять без "
                                                   " предоставления справок из компетентных органов в случаях, "
                                                   " если поврежден только зеркальный или стеклянный элемент и других "
                                                   " повреждений нет.\n 2. Поставить в известность в течение "
                                                   " рабочего дня, оформив отчет о случившемся на "
                                                   " Сервисном Портале/ Транспортный отдел. \n"
        ...
        if call.data == "ss_2_yes":
            bot.send_message(call.message.chat.id, "1. Не перемещая автомобиль, вызвать сотрудников "
                                                   ...
                                                   " от характера повреждений автомобиля, которые поможет вам "
                                                   " определить специалист страхового отдела «Ингосстрах»).\n "
                                                   "2. НЕЗАМЕДЛИТЕЛЬНО сообщить:\nСпециалисту по охране труда и "
                                                   " Менеджеру по транспорту. \n3. Сообщить другому участнику ДТП"
                                                   " номер своего полиса ОСАГО, а также название страховой компании, "
                                                   " которая выдала полис.\n4. Записать данные полиса ОСАГО другого "
                                                   " участника, а также зафиксировать ФИО, адрес, контактные телефоны, "
                                                   " марку и гос. номер его автомобиля. \n 5. Дождаться приезда "
                                                   " сотрудников ГИБДД/Полиции/МЧС непосредственно на месте "
                                                   " происшествия и зафиксировать факт повреждения автомобиля. \n"
                                                   " 6. Получить справку, с указанием всех видимых повреждений, "
                                                   " полученных в ДТП(страхового случая) с Вашим автомобилем.\n "
                                                   " 7. Поставить в известность в течение рабочего дня, оформив отчет "
                                                   " о случившемся на Сервисном Портале/ Транспортный отдел. \n"
                                                   " 8. Обратиться в страховую компанию.")
        if call.data == "ss_2_no":
            bot.send_message(call.message.chat.id, "1. Не перемещая автомобиль, вызвать сотрудников "
                                                   ...
                                                   " от характера повреждений автомобиля, которые поможет вам "
                                                   " определить специалист страхового отдела «Ингосстрах»).\n "
                                                   "2. Сообщить другому участнику ДТП номер своего полиса ОСАГО, "
                                                   "а также название страховой компании, которая выдала полис."
                                                   "\n3. Записать данные полиса ОСАГО другого участника, а также "
                                                   " зафиксировать ФИО, адрес, контактные телефоны, "
                                                   " марку и гос. номер его автомобиля. \n 4. Дождаться приезда "
                                                   " сотрудников ГИБДД/Полиции/МЧС непосредственно на месте "
                                                   " происшествия и зафиксировать факт повреждения автомобиля. \n"
                                                   " 5. Получить справку, с указанием всех видимых повреждений, "
                                                   " полученных в ДТП(страхового случая) с Вашим автомобилем.\n "
                                                   " 6. Поставить в известность в течение рабочего дня, оформив отчет "
                                                   " о случившемся на Сервисном Портале/ Транспортный отдел. \n"
                                                   " 7. Обратиться в страховую компанию.")
        if call.data == "ss_3_yes":
            bot.send_message(call.message.chat.id, "1. Не перемещая автомобиль, вызвать сотрудников "
                                                   ...
                                                   " сотрудников ГИБДД/Полиции/МЧС непосредственно на месте "
                                                   " происшествия и зафиксировать факт повреждения автомобиля. \n"
                                                   " 4. Получить справку, с указанием всех видимых повреждений, "
                                                   " полученных в ДТП(страхового случая) с Вашим автомобилем.\n "
                                                   " 5. Поставить в известность в течение рабочего дня, оформив отчет "
                                                   " о случившемся на Сервисном Портале/ Транспортный отдел. \n"
                                                   " 6. Обратиться в страховую компанию.")
        if call.data == "ss_3_no":
            bot.send_message(call.message.chat.id, "1. Не перемещая автомобиль, вызвать сотрудников "
                                                   ...
                                                   " от характера повреждений автомобиля, которые поможет вам "
                                                   " определить специалист страхового отдела «Ингосстрах»).\n "
                                                   "2. Дождаться приезда сотрудников ГИБДД/Полиции/МЧС "
                                                   "непосредственно на месте происшествия и зафиксировать факт "
                                                   "повреждения автомобиля. \n"
                                                   " 3. Получить справку, с указанием всех видимых повреждений, "
                                                   " полученных в ДТП(страхового случая) с Вашим автомобилем.\n "
                                                   " 4. Поставить в известность в течение рабочего дня, оформив отчет "
                                                   " о случившемся на Сервисном Портале/ Транспортный отдел. \n"
